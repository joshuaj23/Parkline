...
<div class="car-info-box"> <a href="slot-book.php?wid=<?php echo htmlentities($result->wid);?>"><img src="admin/img/warehouse/<?php echo htmlentities($result->image);?>" class="img-responsive" alt="image"></a>
<ul>
<li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->slot);?></li>

<li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->price);?> seats</li>
</ul>
</div>
<div class="car-title-m">
<h6><a href="slot-details.php?vhid=<?php echo htmlentities($result->id);?>"></a></h6>
<span class="price">INR<?php echo htmlentities($result->price);?> /Day</span> 
</div>
