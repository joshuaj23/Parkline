...
$sql="INSERT INTO  tblslot(wid,cate,name,reg,ownername,phno,address) VALUES(`$wid`,`$cate`,`$name`,`$reg`,`$ownername`,`$phno`,`$address`)";
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              ...
              <input type="text" name="cate" class="form-control white_bg" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="pno" class="form-control white_bg"  required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button class="btn" type="submit" name="send" type="submit">BOOK SLOT<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
